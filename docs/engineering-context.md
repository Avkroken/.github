...
- Den tidigare publika portalendpointen `/webhooks/github` är pensionerad och svarar `410 Gone` under övergången. Den externa GitHub-organisationshooken till `avkroken.denied.se` ska tas bort när live-inställningen kan administreras; canonical GitHub-hook pekar på Skvallerbyttan.
